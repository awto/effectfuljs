...
function finallyBlock1() {
  ...
  function _6(ctx) {
    var cb = ctx._cb;
    return ctx._cb = undefined, ctx.yldBH(i, cb);
  }
...
function cfb() {
  ...
  function _3(ctx, a) {
    ...
    try {
      ...
      b = i++;
      return ctx._cb = _8, ctx.yldBH(`a${b}`, _7, _4);
    } catch (ex) {
      return _4(ctx, ex);
    }
  }
  ...
  function _6(ctx) {
    var a;
    a = i++;
    return ctx._r = a, ctx._cb = r_, _7(ctx);
  }
  ...
  function _7(ctx) {
    var a,
        cb = ctx._cb;
    a = i++;
    return ctx._cb = undefined, ctx.yldBH(`f1${a}`, cb);
  }
...
function cfb1() {
  ...
  function _4(ctx, ex) {
    ...
    e = ex;
    a = i++;
    return ctx._r = a, ctx._cb = r_, _5(ctx);
  }

  function _5(ctx) {
    var cb = ctx._cb;
    console.log(`f${i}`);
    return ctx._cb = undefined, cb(ctx);
  }
...
function cfb2() {
  ...
  function _4(ctx) {
    ...
    try {
      a = i++;
      return ctx._cb = _8, ctx.yldBH(`c:${a}`, _5, _c);
    } catch (ex) {
      return _c(ctx, ex);
    }
  }
  ...
  function _5(ctx) {
    ...
    try {
      a = i++;
      return ctx._cb = undefined, ctx.yldBH(`f:${a}`, cb, __c);
    } catch (ex) {
      return ctx._cb = undefined, __c(ctx, ex);
    }
  }
...
function cfb3() {
  ...
  function _3(ctx, a) {
    try {
      ...
      return ctx._cb = _5, ctx.yldBH(`a${i}`, _4, _c);
    } catch (ex) {
      return _c(ctx, ex);
    }
  }
  ...
  function _4(ctx) {
    ...
    try {
      a = i++;
      return ctx._cb = undefined, ctx.yldBH(`f1${a}`, cb, __c);
    } catch (ex) {
      return ctx._cb = undefined, __c(ctx, ex);
    }
  }
...
function _cfb2() {
  ...
  function _2(ctx) {
    ...
    try {
      a = i++;
      return ctx._cb = _6, ctx.yldBH(`c:${a}`, _3, _c);
    } catch (ex) {
      return _c(ctx, ex);
    }
  }
...
function c2() {
  ...
  function inner() {
    ...
    function _1(ctx) {
      ...
      b = c;
      k = 1;
      return ctx._ = undefined, ctx.jBH(b(), _2);
    }
