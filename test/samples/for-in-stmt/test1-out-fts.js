...
function h_10(a, j, loop, _loop) {
  if (a) return h_11(j, loop);else {
    return M.jM3R(eff('c'), h_5, j, loop, _loop);
  }
}

function h_11(j, loop) {
  return M.jM1R(effB(j), h_2, loop);
}
