...
function a03() {
  ...
  function _1(i, j) {
    ...
    try {
      a = i++;
      return M.jH(eff('inner', a, j), _2, _3, i, j);
    } catch (_ex) {
      return _3(_ex, i, j);
    }
  }
  ...
  function _3(_ex, i, j) {
    ...
    ex = e;
    a = j++;
    return M.j(eff('exception', e, a), _4, i, ex);
  }
...
function a04() {
  ...
  a = i++;
  b = j = 0;
  return M.j(eff(1, a, b), _1, i, j);

  function _1(i, j) {
    var a, b;
    a = i++;
    b = j = j + 1;
    return M.j(eff(2, a, b), _2, i, j);
  }

  function _2(i, j) {
    return M.j(eff(3, i, j), _3, i, j);
  }

  function _3(i, j) {
    return M.j(eff(4), _4, i, j);
  }

  function _4(i, j) {
    return M.j(eff(5, i), _5, i, j);
  }

  function _5(i, j) {
    if (something) return _9(i, j, _18, undefined);else {
      if (something2) return _9(i, j, _19, _22);else {
        if (something3) return _6(i, j);else {
          if (something4) return _7(i, j);else return _8(i, j);
        }
      }
    }
  }
  ...
  function _6(i, j) {
    return _9(i, j, _19, _23);
  }

  function _7(i, j) {
    return M.j(eff(6), _8, i, j);
  }
  ...
  function _9(i, j, cb1, cb2) {
    return M.j(eff(7), _10, i, j, cb1, cb2);
  }

  function _10(i, j, cb1, cb2) {
    if (something5) return _11(i, j, cb1, cb2);else return _24(i, j, _13, _19, cb1, _22);
  }

  function _11(i, j, cb1, cb2) {
    return M.j(eff(8, j), _12, [i, j, _13, _16, cb1, cb2]);
  }

  function _24(i, j, cb, _cb, cb1, cb2) {
    console.log('i');
  ...
  function _13(i, j, _cb, cb1, cb2) {
    var a;
    a = j = j + 1;
    return M.j(eff(9, a), _14, i, j, _cb, cb1, cb2);
  }

  function _14(i, j, _cb, cb1, cb2) {
    return M.j(eff(10), _15, i, j, _cb, cb1, cb2);
  }

  function _15(i, j, _cb, cb1, cb2) {
    console.log(j);
    return _cb(i, cb1, cb2);
  }

  function _16(i, cb1, cb2) {
    return M.j(eff(11), _17, i, cb1, cb2);
  }

  function _17(i, cb1, cb2) {
    console.log(11);
    return cb1(i, cb2);
  }

  function _18(i, cb2) {
    return M.j(eff(12), _19, i, undefined, _21);
  }

  function _19(i, cb1, cb2) {
    var a;
    a = i = i + 1;
    return M.j(eff(13, a), _20, i, cb2);
  }
  ...
  function _21(i) {
    return M.j(eff(15, i), _22, i);
  }

  function _22(i) {
    return M.j(eff(16), _23, i);
  }
...
function a38(a1) {
  ...
  i = 0;
  j = 0;
  return M.j(eff('pref', i, j), _1, i, j);

  function _1(i, j) {
    i += 1, j += 2;
    if (i > 10) return _2(i);else {
      return M.j(eff('body', i, j), _3, i, _4, undefined);
    }
  }

  function _2(i) {
    return _3(10, i, r_, 10);
  }
...
function a39(a1) {
  ...
  function _1(i, j) {
    ...
    if (i > 10) return _2(i, j);else {
      return M.j(eff('body', i, j), _3, i, j, _4, undefined);
    }
  }

  function _2(i, j) {
    return _3(10, i, j, r_, 10);
  }

  function _3(i, j, cb, r) {
...
function a40(a1) {
  ...
  function _1(i, j) {
    var a;
    a = j++;
    return M.j(eff('l1', i, a), _2, i, j);
  }

  function _2(i, j) {
    i += 1;
    if (i > 10) return _3(i, j);else {
      if (j > 10) return _4(i, j, _6, _7, undefined);else {
        return M.j(eff('l1 > body', i, j), _4, i, j, _5, undefined, undefined);
      }
    }
  }

  function _3(i, j) {
    return _4(10, i, j, _6, r_, 10);
  }

  function _4(i, j, cb, _cb, r) {
    return M.j(eff('l1 > finally', i), cb, i, j, _cb, r);
  }

  function _5(i, j, _cb, r) {
    return M.j(eff('l1 > exit', j), _6, i, j, _7, r);
  }

  function _6(i, j, _cb, r) {
    return M.j(eff('body > finally', i), _cb, j, r);
  }

  function _7(j, r) {
    return M.j(eff('exit', j), _8, j, r);
  }
