...
function a18_2(a) {
  if (a === 1) return a18_3(a18_5);else {
    return M.jM1R(eff(2), a18_3, a18_1);
  }
}
...
function a37_2(cb) {
  return M.jM1(eff('l1>try-body>l2>try-finally'), a37_3, cb);
}
...
function a30(a1, a2) {
  if (a1) return a30_2(a30_1);else {
    return M.jM1(eff(2), a30_2, a30_5);
  }
}
...
function a37(a1, a2) {
  if (a1) return a37_2(a37_1);else {
    return M.jM1(eff('l1>try-body>l2>try-body'), a37_2, a37_5);
  }
}
