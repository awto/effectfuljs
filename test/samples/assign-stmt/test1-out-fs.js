...
function b() {
  ...
  function _1(b1) {
    return M.jB(eff(2), _2, b1);
  }

  function _2(b2, b1) {
    return M.j(eff(b1), _3, b2);
  }
...
function e2() {
  ...
  function _2(cc) {
    return M.j(eff(3, cc), _3, cc);
  }

  function _3(cc) {
    var _cc;

    return M.jB(eff(4, _cc), _4, cc);
  }

  function _4(_cc, cc) {
    return M.jB(eff(5, _cc), _5, cc);
  }

  function _5(_cc, cc) {
    return M.j(eff(6, _cc), _6, cc);
  }
