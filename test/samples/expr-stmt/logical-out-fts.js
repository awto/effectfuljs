...
function a19_1(a) {
  return a ? a19_3() : M.jM(eff(2), a19_2);
}
...
function b_3(a) {
  return a ? M.jM(eff(2), b_4) : b_4();
}

function b_4() {
  var a;
  a = 1;
  return a ? b_5() : M.jM(eff(2), b_5);
}
