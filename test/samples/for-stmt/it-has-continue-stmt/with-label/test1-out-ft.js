...
function __3(_v) {
  if (_v.j < _v.len) {
    d = _v.ref[_v.j];
    return M.jMB(eff(d), __4, _v);
  } else return _7(_v);
}

function __4(a, _v) {
  if (a) return __6(_v);else {
    return M.jMB(eff(2), __5, _v);
  }
}
