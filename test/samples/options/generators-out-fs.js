...
function ag3(i) {
  ...
  function _7(i, loop) {
    j = loop.value;
    return G.yldM(i + j, _8, i, loop);
  }

  function _8(i, loop) {
    var a;
    a = eff(j);
    return G.jMB(a, _9, i, loop);
  }
  ...
  function _11(i, loop) {
    var a;
    a = eff(2, j);
    return G.yldStarMB(a, _12, loop);
  }

  function _12(i, loop) {
    return G.jR(_5, i, loop);
  }
}
