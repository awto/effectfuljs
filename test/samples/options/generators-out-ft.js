...
function ag2_5(a, ag2_v, loop) {
  ag2_v.i = a;
  return M.jR(ag2_2, ag2_v, loop);
}

function ag3_1(ag3_v) {
  return M.yld(ag3_v.i, ag3_2, ag3_v);
}

function ag3_2(ag3_v) {
  var a;
  a = eff(ag3_v.i);
  return M.chainB(a, ag3_3, ag3_v);
}

function ag3_3(a, ag3_v) {
  return M.yld(a, ag3_4, ag3_v);
}

function ag3_4(ag3_v) {
  var loop;
  loop = M.iteratorM(something());
  return ag3_5(ag3_v, loop);
}

function ag3_5(ag3_v, loop) {
  return M.chainB(loop.incrM(), ag3_6, ag3_v);
}

function ag3_6(loop, ag3_v) {
  var a;
  if (!a.done) return ag3_7(ag3_v, loop);else {
    return M.pure(ag3_v.i);
  }
}

function ag3_7(ag3_v, loop) {
  ag3_v.j = loop.value;
  return M.yld(ag3_v.i + ag3_v.j, ag3_8, ag3_v, loop);
}

function ag3_8(ag3_v, loop) {
  var a;
  a = eff(ag3_v.j);
  return M.chainB(a, ag3_9, ag3_v, loop);
}

function ag3_9(b, ag3_v, loop) {
  var a;
  a = eff(ag3_v.i - b);
...
function ag3_11(a, ag3_v, loop) {
  var b;
  ag3_v.i = a;
  b = eff(2, ag3_v.j);
  return M.yldStarB(b, ag3_12, ag3_v, loop);
}

function ag3_12(a, ag3_v, loop) {
  ag3_v.i = a;
  return M.jR(ag3_5, ag3_v, loop);
}
