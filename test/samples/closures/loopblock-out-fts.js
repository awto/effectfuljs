    ...
    var _v = {
      ...
      var b_v = {
        b: undefined
          ...
          a;
      a = k++;
      return M.j(eff(4, _a_v.a, __v.j, a, _a_v.p), b_1, k, _a_v, __v);
    },
        _a_v = a_v;
...
function b_1(k, _a_v, __v) {
  ...
  __v.i++;
  _k++, _a_v.p++;
  return M.j(eff(5, _a_v.a, __v.i, _k, _a_v.p), b_2, k, _a_v, __v);
}

function b_2(k, _a_v, __v) {
  return M.j(eff(6, _a_v.a, __v.i, k, _a_v.p), b_3);
}
...
function a_4(a_v, loop, a) {
  var i;
  i = loop.value;
  return M.jR(a(i), a_3, a_v, loop, a);
}
