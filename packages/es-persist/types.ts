...
export interface Thenable<T=any> {
  then<U>(resolve?:(value:T) => U|Thenable<U>,
          reject?: (reason: any) => U|Thenable<U>): Thenable<U>
}
 ...
 */
export interface AsyncGenerator<O=any,I=any,R=any,E=any> extends AsyncIterator<O, I, R>, Job {
 ...
 * serializable the result is serializable too
 */
export declare function any<T>(iterable: Iterable<AsyncValue<T>>): AsyncValue<T>;
