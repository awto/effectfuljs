 ...
 */
export function withSubCont<A, B>(p: Prompt<B>, f: (sc: SubCont<A, B>) => CCV<B>): CC<A> {
 ...
 */
export function shift<A, B>(p: Prompt<B>, f: (k: (v: A) => CCV<B>) => CCV<B>): CCV<A> {
  return withSubCont<A, B>(
    p, sk =>
      pushPrompt(p,
 ...
 */
export function control<A, B>(p: Prompt<B>, f: (k: (v: A) => CCV<B>) => CCV<B>): CCV<A> {
 ...
 */
export function shift0<A, B>(p: Prompt<B>, f: (k: (v: A) => CCV<B>) => CCV<B>): CCV<A> {
 ...
 */
export function control0<A, B>(p: Prompt<B>, f: (k: (v: A) => CCV<B>) => CCV<B>): CCV<A> {
