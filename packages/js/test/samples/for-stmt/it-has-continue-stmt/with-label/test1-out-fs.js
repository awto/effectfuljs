(function () {
  ...
  function _4(a, i, j, len, ref) {
    if (a) {
      return M.jump(_5, _7, i, j, len, ref);
    } else {
      if (t1) {
        return M.jump(_6, _7, i, ref);
      } else {
...
(function () {
  ...
  ref = [1, 2, 3];
  i = 0;
  return M.jump(_1, _7, i, void 0, ref);
...
(function () {
  var j, len;
  j = 0;
  return M.jump(_1, _5, j);

  function _1(j) {
    if (true) {
      return M.chain(eff(j), _2, _5, j);
    } else {
      return M.jump(_3, _5, j);
    }
  }
