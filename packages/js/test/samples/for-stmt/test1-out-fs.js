(function () {
  ...
  function _3(j, len, ref) {
    j++;
    return M.repeat(_1, _4, j, len, ref);
  }
...
(function () {
  ...
  function _3(i) {
    var j;
    j = 0;
    return M.jump(_4, _9, i, j);
  }

  function _4(i, j) {
    if (j < 40) {
      if (j === 10) {
        return M.jump(_6, _9, i);
      } else {
        if (j === 30) {
          return M.jump(_7, _9);
        } else {
  ...
  function _5(i, j) {
    j += 10;
    return M.repeat(_4, _9, i, j);
  }

  function _6(i) {
    i++;
    return M.repeat(_2, _9, i);
  }
...
function d() {
  ...
  function _2(a, i) {
    ...
    result = a;
    i++;
    return M.repeat(_1, _4, result, i);
  }
