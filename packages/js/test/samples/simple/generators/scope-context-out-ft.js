...
function d_1(d) {
  ...
  d._j = 0;
  a = d._i++;
  return M.yldStar(M.yld(a), d_2, d_7);
}

function d_2(d, a) {
  var b;
  b = d._j++;
  return M.yldStar(M.yld((a, b)), d_3, d_7);
}

function d_3(d) {
  return M.yldStar(M.yldStar(some(d._i += 2, d._j) + d._j), d_4, d_7);
}

function d_4(d, a) {
  return M.yldStar(M.yld(a), d_5, d_7);
}
...
function a4_3(a4) {
  ...
  return M.yldStar(M.yld(3), a4_6, a4_12);
}
...
function a4_5(a4) {
  a4._fc = a4_8, a4._fe = a4_12;
  return M.yldStar(M.yld(a4._e), a4_6, a4_12);
}

function a4_6(a4) {
  return M.yldStar(M.yld('f'), a4_7, a4_12);
}
...
function a4_9(a4, b) {
  ...
  a4._1 = b;
  a = a3();
  return M.yldStar(M.yldStar(a), a4_10, a4_12);
}

function a4_10(a4, b) {
  var a;
  a = a1(a4._1, b);
  return M.yldStar(M.yld(a), a4_11, a4_12);
}
