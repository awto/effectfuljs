...
function d_1(d, i) {
  ...
  j = 0;
  a = i++;
  return M.yldStar(M.yld(a), d_2, d_7, i, j);
}

function d_2(d, a, i, j) {
  var b;
  b = j++;
  return M.yldStar(M.yld((a, b)), d_3, d_7, i, j);
}

function d_3(d, i, j) {
  return M.yldStar(M.yldStar(some(i += 2, j) + j), d_4, d_7, i);
}

function d_4(d, a, i) {
  return M.yldStar(M.yld(a), d_5, d_7, i);
}
...
function d_5(d, a, i) {
  ...
  if (a) {
    b = i += 3;
    return M.yldStar(M.yldStar(b), d_6, d_7);
  } else {
    return M.pure(i);
  }
}
...
function a4_3(a4) {
  return M.yldStar(M.yld(3), a4_6, a4_12, a4_8, a4_12);
}
...
function a4_5(a4) {
  return M.yldStar(M.yld(a4._e), a4_6, a4_12, a4_8, a4_12);
}

function a4_6(a4, fc, fe, err) {
  return M.yldStar(M.yld('f'), a4_7, a4_12, fc, fe, err);
}
...
function a4_8(a4) {
  var a;
  a = a2();
  return M.yldStar(M.yldStar(a), a4_9, a4_12);
}

function a4_9(a4, a) {
  var b;
  b = a3();
  return M.yldStar(M.yldStar(b), a4_10, a4_12, a);
}

function a4_10(a4, c, a) {
  var b;
  b = a1(a, c);
  return M.yldStar(M.yld(b), a4_11, a4_12);
}
