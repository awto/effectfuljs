function forOfBlockScope() {
  ...
  function _1() {
    ...
    loop = M.iterator(a);
    return M.jump(_2, _48);
  }

  function _2() {
    if (!(loop = loop.step()).done) {
      i3 = loop.value;
      return M.jump(_3, _49);
    } else {
      _loop = M.iterator(a);
      return M.jump(_5, _48);
    }
  }
  ...
  function _5() {
    if (!(_loop = _loop.step()).done) {
      i4 = _loop.value;
      return M.jump(_6, _50);
    } else {
      loop1 = M.iterator(a);
      return M.jump(_8, _48);
    }
  }
  ...
  function _8() {
    if (!(loop1 = loop1.step()).done) {
      i5 = loop1.value;
      return M.jump(_9, _51);
    } else {
      loop2 = M.iterator(funs);
      return M.jump(_11, _48);
    }
  }
  ...
  function _12() {
    var a;
    a = _i();
    return M.repeat(M.yldStar(a), _11, _48);
  }
  ...
  function _14() {
    if (!(loop3 = loop3.step()).done) {
      i7 = loop3.value;
      return M.jump(_15, _53);
    } else {
      k = 0;
      loop4 = M.iterator(a);
      return M.jump(_17, _48);
    }
  }
  ...
  function _21() {
    ...
    k = 0;
    loop5 = M.iterator(a);
    return M.jump(_22, _48);
  }

  function _22() {
    if (!(loop5 = loop5.step()).done) {
      i10 = loop5.value;
      return M.jump(_23, _55);
    } else {
  ...
  function _26() {
    k = 0;
    loop6 = M.iterator(a);
    return M.jump(_27, _48);
  }

  function _27() {
    if (!(loop6 = loop6.step()).done) {
      i11 = loop6.value;
      return M.jump(_28, _56);
    } else {
  ...
  function _32() {
    loop7 = M.iterator(a);
    return M.jump(_33, _48);
  }

  function _33() {
    if (!(loop7 = loop7.step()).done) {
      i12 = loop7.value;
      return M.jump(_34, _57);
    } else {
  ...
  function _38() {
    loop8 = M.iterator(a);
    return M.jump(_39, _48);
  }

  function _39() {
    if (!(loop8 = loop8.step()).done) {
      i13 = loop8.value;
      return M.jump(_40, _58);
    } else {
  ...
  function _43() {
    k2 = 0;
    loop9 = M.iterator(a);
    return M.jump(_44, _48);
  }

  function _44() {
    if (!(loop9 = loop9.step()).done) {
      i14 = loop9.value;
      return M.jump(_45, _59);
    } else {
      return M.pure(r);
    }
  }
      ...
      function _4() {
        return M.yldStar((j => {
          ...
          function _4() {
            var a;
            a = _i();
            return M.repeat(M.yldStar(a), _3, _6);
          }
  ...
  function _49(a) {
    ex = a;
    return M.jump(_4, _48);
  }

  function _50(a) {
    _ex = a;
    return M.jump(_7, _48);
  }

  function _51(a) {
    ex1 = a;
    return M.jump(_10, _48);
  }

  function _52(a) {
    ex2 = a;
    return M.jump(_13, _48);
  }

  function _53(a) {
    ex3 = a;
    return M.jump(_16, _48);
  }

  function _54(a) {
    ex4 = a;
    return M.jump(_20, _48);
  }

  function _55(a) {
    ex5 = a;
    return M.jump(_25, _48);
  }

  function _56(a) {
    ex6 = a;
    return M.jump(_30, _48);
  }

  function _57(a) {
    ex7 = a;
    return M.jump(_36, _48);
  }

  function _58(a) {
    ex8 = a;
    return M.jump(_42, _48);
  }

  function _59(a) {
    ex9 = a;
    return M.jump(_47, _48);
  }
}