...
function e1(k) {
  var e1 = M.generator();
  e1._k = k;
  return M.scope(e1_1, _e1_4);
}

function e1(k) {
  var e1 = M.generator();
  e1._k = k;
  return M.scope(_e1_1, e1_4);
}
...
function nn_1(nn) {
  return M.yldStar(M.yld(m => {
    var mfs = nn._mfs,
        ...
        vv = nn._vv,
        _nn = nn;
    return vv._id(kk._k, mfs._v, w, m, vv._ww, _nn._mm);
  }), nn_2, nn_4);
}
...
function e1_1(e1) {
  var a;
  a = e1._k;
  return M.yldStar(M.yld(a), e1_2, _e1_4);
}

function e2_1(_e2) {
  var a;
  a = _e2._e1._k += _e2._l;
  return M.yldStar(M.yld(a), _e2_2, _e2_3);
}
...
function _e1_1(e1) {
  var a;
  a = e1._k;
  return M.yldStar(M.yld(a), _e1_2, e1_4);
}
