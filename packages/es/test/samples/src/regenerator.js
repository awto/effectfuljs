global.regeneratorRuntime = {
  wrap: function() { throw new Error("should not be called"); },
  mark: function() { throw new Error("should not be called"); },
  isGeneratorFunction: function(v) { return v && v.constructor.name === "GeneratorFunction" }
}
