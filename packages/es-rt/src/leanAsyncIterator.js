...
AsyncIteratorPrototype[Symbol.asyncIterator] = function() {
  return this;
};
...
export var iteratorM = function asyncIterator(cont) {
  return cont[Symbol.asyncIterator]
    ? cont[Symbol.asyncIterator]()
    : cont[Symbol.iterator](cont);
};

export function cancel(promise) {
  if (promise && promise[cancelSym]) return promise[cancelSym]();
