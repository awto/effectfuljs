...
/**
 * Converts JSON Object returned by `write` back to JS Object
 */
...
declare const descriptorSymbol: unique symbol

/**
 * Serializable object value must have `[descriptorSymbol]` property
 * returning descriptor. The property isn't required if the value
 * is registered as primitive (it can be done for objects too).
 */
...
/** 
 * This adds descriptor to internal global registry for creating value 
