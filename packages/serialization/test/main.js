...
describe("object with parent", function() {
  ...
  context("for shared values", function() {
    ...
    it("shouldn't duplicate shared values", function() {
      const root = new Obj2()
      root.l1 = new Obj2()
    ...
    it("should resolve `#ref` to a reference", function() {
...
describe("arrays serialization", function() {
  context("without shared references",function() {
    it("should contain type and data fields",
       function() {
  ...
  context("without shared references",function() {
    it("should output `JSON.stringify` serializable object", function() {
      ...
      assert.deepStrictEqual(
        res, {map:{"#type":"Map",
                   "#data":[[1,"a"],
                            [true,{"#type":"Array","#data":[false,null]}],
                            [undefined,undefined]]}})
      const back = Lib.read(res)
      assert.deepStrictEqual(obj, back)
    })
...
describe("opaque values pattern", function() {
  it("should replace opaque values with unique ids", function() {
    ...
    assert.deepStrictEqual(
      ...
      {a:1,
       b:{"#opaque":0},
       c:{"#type":"Array","#data":[{"#opaque":1},{"#type":"Symbol","name":"d"}]},
       recMap:{"#type":"Map",
               "#data":[[{"#opaque":2},{"#ref":0}],[{"#ref":0},{"#opaque":2}]],
               "#id":1},
       rec:{"#type":"Set","#data":[{"#ref":0},{"#ref":1}]},"#id":0})
