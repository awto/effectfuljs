...
function a03() {
  ...
  a = i++;
  return M.chainBH(eff(a, j), _1, _8);

  function _1() {
    var a;
    a = i++;
    return M.chainBH(eff('inner', a, j), _2, _8);
  }
  ...
  function _3() {
    ...
    ex = e;
    a = j++;
    return M.chainBH(eff('exception', e, a), _4, _7);
  }
...
function a04() {
  ...
  a = i++;
  b = j = 0;
  return M.chainBH(eff(1, a, b), _1, _21);

  function _1() {
    var a, b;
    a = i++;
    b = j = j + 1;
    return M.chainBH(eff(2, a, b), _2, _21);
  }

  function _2() {
    return M.chainBH(eff(3, i, j), _3, _26);
  }

  function _3() {
    return M.chainBH(eff(4), _4, _27);
  }

  function _4() {
    return M.chainBH(eff(5, i), _5, _27);
  }

  function _5() {
    if (something) {
      _fc = _15, _fe = _26;
      return M.jumpH(_7, _26);
    } else {
      if (something2) {
        ...
        if (something3) {
          ...
          if (something4) {
            return M.chainBH(eff(6), _6, _27);
          } else {
            return M.jumpH(_6, _27);
          }
        }
      }
    }
  ...
  function _7() {
    return M.chainBH(eff(7), _8, _29);
  }

  function _8() {
    if (something5) {
      fc = _13, fe = _26;
      return M.chainBH(eff(8, j), _9, _28);
    } else {
      fc = _16, fe = _21, fc1 = _19, fe1 = _21;
      return M.jumpH(_9, _28);
    }
  }
  ...
  function _9() {
    console.log('i');
    err1 = err2;
    return M.jumpH(_10, _26);
  }

  function _10() {
    var a;
    a = j = j + 1;
    return M.chainBH(eff(9, a), _11, _26);
  }

  function _11() {
    return M.chainBH(eff(10), _12, _26);
  }
  ...
  function _13() {
    return M.chainBH(eff(11), _14, _26);
  }
  ...
  function _15() {
    fc1 = _18, fe1 = _21;
    return M.chainBH(eff(12), _16, _21);
  }

  function _16() {
    var a;
    a = i = i + 1;
    return M.chainBH(eff(13, a), _17, _21);
  }

  function _17() {
    return M.chainBH(eff(14), fc1, fe1);
  }
  ...
  function _7(a) {
    ...
    if (a1 === 1) {
      ...
      if (a1 === 2) {
        ...
        fc = _10, fe = _20;
        return M.chainBH(eff(7), _8, _20);
      }
    }
  }

  function _8() {
    return M.chainBH(eff(8), _9, _20);
  }

  function _9() {
    err = _err;
    return M.chainBH(eff(9), fc, fe);
  }

  function _10() {
    _fc = _13, _fe = _17;
    return M.chainBH(eff(10), _11, _17);
  }

  function _11() {
    return M.chainBH(eff(11), _12, _17);
  }

  function _12() {
    return M.chainBH(eff(12), _fc, _fe);
  }
...
function a10() {
  ...
  function _4(b) {
    ...
    if (a) {
      ...
      fc = _9, fe = _12;
      return M.jumpH(_5, _15);
    }
  }

  function _5() {
    return M.chainBH(eff(8), _6, _15);
  }

  function _6() {
    err = _err;
    return M.chainBH(eff(9), _7, _12);
  }

  function _7() {
    return M.chainBH(eff(11), _8, _12);
  }

  function _8() {
    return M.chainBH(eff(12), fc, fe);
  }
...
function a11() {
  ...
  function _1() {
    fc = _3, fe = _10;
    return M.chainBH(eff(1), _2, _10);
  }

  function _2() {
    err = _err;
    return M.chainBH(eff(2), fc, fe);
  }

  function _3() {
    _fc = _5, _fe = _7;
    return M.chainBH(eff('a'), _4, _7);
  }

  function _4() {
    return M.chainBH(eff(3), _fc, _fe);
  }
...
function a14() {
  ...
  function _5() {
    return M.chainBH(eff(5), _1, _15);
  }

  function _6() {
    return M.chainBH(eff(6), _7, _11);
  }

  function _7() {
    return M.chainBH(eff(7), _fc, _fe);
  }

  function _8() {
    return M.chainBH(eff(8), _9, _11);
  }
...
function a18() {
  ...
  function _2(b) {
    ...
    if (a === 1) {
      ...
      fc = _1, fe = _9;
      return M.chainBH(eff(2), _3, _7);
    }
  }

  function _3() {
    return M.chainBH(effF(3), _4, _7);
  }

  function _4() {
    return M.chainBH(effF(4), fc, fe);
  }
...
function a19() {
  ...
  function _1() {
    return M.chainBH(eff(1), _2, _6);
  }

  function _2() {
    fc = _1, fe = _4;
    return M.chainBH(eff(2), _3, _4);
  }

  function _3() {
    return M.chainBH(effF(3), fc, fe);
  }
...
function a21() {
  ...
  function _3() {
    return M.chainBH(effFF(4), fc, fe);
  }
...
function a23() {
  ...
  function _3() {
    return M.chainBH(effFF(5), _fc, _fe);
  }
...
function a28() {
  ...
  function _1() {
    if (a1) {
      ...
      return M.jumpH(_2, _13);
    } else {
      _fc = _5, _fe = _13;
      return M.chainBH(eff(2), _2, _13);
    }
  }

  function _2() {
    return M.chainBH(eff(3), _3, _15);
  }

  function _3() {
    if (a2) {
      fc = _5, fe = _13;
      return M.jumpH(_4, _13);
    } else {
      fc = _fc, fe = _fe;
      return M.chainBH(eff(4), _4, _13);
    }
  }
  ...
  function _5() {
    fc1 = _7, fe1 = _9;
    return M.chainBH(eff(6), _6, _9);
  }

  function _6() {
    return M.chainBH(eff(7), fc1, fe1);
  }
...
function a34() {
  ...
  function _3() {
    _fc = _6, _fe = _8;
    return M.chainBH(eff(3), _5, _8);
  }

  function _4() {
    e = ex;
    _fc = _6, _fe = _8;
    return M.chainBH(eff(e), _5, _8);
  }

  function _5() {
    return M.chainBH(eff(4), _fc, _fe);
  }
...
function a35() {
  ...
  function _1() {
    console.log('hi');
    fc = _3, fe = _8;
    return M.chainBH(eff('try>try>body'), _2, _8);
  }

  function _2() {
    ex = err;
    return M.chainBH(eff('try>try>finally'), fc, fe);
  }
...
function a36(a1) {
  ...
  function _1() {
    if (a1) {
      ...
      fc = _3, fe = _4;
      return M.chainBH(eff('body'), _2, _4);
    }
  }

  function _2() {
    return M.chainBH(eff('finally'), fc, fe);
  }
...
function a37(a1, a2) {
  ...
  function _1() {
    if (a1) {
      ...
      _fc = _5, _fe = _13;
      return M.chainBH(eff('l1>try-body>l2>try-body'), _2, _13);
    }
  }

  function _2() {
    return M.chainBH(eff('l1>try-body>l2>try-finally'), _3, _15);
  }
  ...
  function _3() {
    if (a2) {
      ...
      fc = _fc, fe = _fe;
      return M.chainBH(eff('l1>try-body>l2>try-finally>try-body'), _4, _13);
    }
  }

  function _4() {
    err = err1;
    return M.chainBH(eff('l1>try-body>l2>try-finally>try-finally'), fc, fe);
  }

  function _5() {
    fc1 = _7, fe1 = _9;
    return M.chainBH(eff('l1>try-body'), _6, _9);
  }

  function _6() {
    return M.chainBH(eff('l1>try-finally'), fc1, fe1);
  }
...
function a38(a1) {
  ...
  i = 0;
  j = 0;
  return M.chainBH(eff('pref', i, j), _1, _6);
  ...
  function _1() {
    ...
    if (i > 10) {
      ...
      fc = _3, fe = _4;
      return M.chainBH(eff('body', i, j), _2, _4);
    }
  }

  function _2() {
    return M.chainBH(eff('finally', i), fc, fe);
  }
...
function a39(a1) {
  ...
  i = 0;
  j = 0;
  return M.chainBH(eff('pref', i, j), _1, _7);
  ...
  function _1() {
    ...
    if (i > 10) {
      ...
      fc = _3, fe = _5;
      return M.chainBH(eff('body', i, j), _2, _5);
    }
  }
  ...
  function _3() {
    return M.chainBH(eff('exit', j), _4, _5);
  }
...
function a40(a1) {
  ...
  i = 0;
  j = 0;
  return M.chainBH(eff('pref', i, j), _1, _11);

  function _1() {
    var a;
    a = j++;
    return M.chainBH(eff('l1', i, a), _2, _12);
  }
  ...
  function _2() {
    ...
    if (i > 10) {
      ...
      if (j > 10) {
        ...
        fc = _4, fe = _11;
        return M.chainBH(eff('l1 > body', i, j), _3, _11);
      }
    }
  }
  ...
  function _3() {
    err = _err;
    return M.chainBH(eff('l1 > finally', i), fc, fe);
  }

  function _4() {
    _fc = _6, _fe = _8;
    return M.chainBH(eff('l1 > exit', j), _5, _8);
  }

  function _5() {
    return M.chainBH(eff('body > finally', i), _fc, _fe);
  }

  function _6() {
    return M.chainBH(eff('exit', j), _7, _8);
  }
...
function a42(a1) {
  ...
  function _4() {
    return M.chainBH(eff('exit'), _5, _7);
  }
