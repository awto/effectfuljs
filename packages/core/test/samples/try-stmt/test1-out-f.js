...
function a10() {
  ...
  function _5() {
    return M.chain(eff(8), _6, _14);
  }

  function _6() {
    err = _err;
    return M.chain(eff(9), _7);
  }

  function _7() {
    return M.chain(eff(11), _8);
  }
  ...
  function _2(b) {
    ...
    if (a === 1) {
      ...
      if (a === 2) {
        ...
        if (a === 3) {
          fc = _6, fe = _10, _fc = _9, _fe = _10, r = 1;
          return M.jump(void 0, _3, _13);
        } else {
          if (a === 4) {
            fc = _6, fe = _10, _fc = _9, _fe = _10;
            return M.jump(void 0, _3, _13);
          } else {
            if (a === 5) {
              return eff('REZ');
