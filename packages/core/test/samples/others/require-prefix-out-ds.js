...
var $M = require("@effectful/debugger"),
  ...
  $m$0 = $M.fun("m$0", "file.js", null, null, [], 0, 6, "1:0-7:0", 32, function ($, $l, $p) {
    for (;;) switch ($.state = $.goto) {
      ...
      case 10:
        $.goto = 11;
        $p = ($x.call = $get, $l[4].name);
        $.state = 11;
      case 11:
        $.goto = 12;
        $p = $mcall("concat", "module-", $p);
        $.state = 12;
      case 12:
        $.goto = 13;
  ...
  }, null, null, 0, [[4, "1:0-1:30", $s$1], [2, "1:10-1:29", $s$1], [4, "2:0-2:34", $s$1], [2, null, $s$1], [2, "2:10-2:33", $s$1], [4, "3:0-3:30", $s$1], [2, "3:10-3:29", $s$1], [4, "4:0-4:29", $s$1], [2, "4:10-4:28", $s$1], [4, "5:0-5:37", $s$1], [2, "5:27-5:33", $s$1], [2, null, $s$1], [2, "5:10-5:36", $s$1], [4, "6:0-6:19", $s$1], [2, "6:0-6:18", $s$1], [16, "7:0-7:0", $s$1], [16, "7:0-7:0", $s$1]]);
$M.moduleExports();