...
function forOfBlockScope() {
  ...
  function _2() {
    ...
    if (!(loop = loop.step()).done) {
      ...
      return M.yldStar(M.yldStar(a), _2, _57);
    } else {
      fc = _4, fe = _44;
      return M.jump(void 0, _3);
    }
  ...
  function _5() {
    ...
    if (!(_loop = _loop.step()).done) {
      ...
      return M.yldStar(M.yldStar(a), _5, _58);
    } else {
      _fc = _7, _fe = _44;
  ...
  function _8() {
    ...
    if (!(loop1 = loop1.step()).done) {
      ...
      return M.yldStar(M.yldStar(a), _8, _59);
    } else {
      fc1 = _10, fe1 = _44;
  ...
  function _11() {
    ...
    if (!(loop2 = loop2.step()).done) {
      _i = loop2.value;
      a = _i();
      return M.yldStar(M.yldStar(a), _11, _60);
    } else {
      fc2 = _13, fe2 = _44;
  ...
  function _14() {
    ...
    if (!(loop3 = loop3.step()).done) {
      ...
      return M.yldStar(M.yldStar(a), _14, _61);
    } else {
      fc3 = _16, fe3 = _44;
  ...
  function _17() {
    ...
    if (!(loop4 = loop4.step()).done) {
      ...
      return M.yldStar(M.yldStar(a), _18, _62);
    } else {
      fc4 = _20, fe4 = _44;
  ...
  function _21() {
    ...
    if (!(loop5 = loop5.step()).done) {
      ...
      a = (i => {
        ...
        function _3() {
          ...
          if (!(loop = loop.step()).done) {
            ...
            return M.yldStar(M.yldStar(a), _4, _11);
          } else {
            fc = _6, fe = _8;
      ...
      return M.yldStar(M.yldStar(a), _22, _63);
    } else {
      fc5 = _24, fe5 = _44;
  ...
  function _25() {
    ...
    if (!(loop6 = loop6.step()).done) {
      ...
      a = (i => {
        ...
        function _2() {
          ...
          if (!(loop = loop.step()).done) {
            ...
            return M.yldStar(M.yldStar(a), _3, _10);
          } else {
            fc = _5, fe = _7;
            return M.jump(void 0, _4);
          }
      ...
      return M.yldStar(M.yldStar(a), _26, _64);
    } else {
      fc6 = _28, fe6 = _44;
  ...
  function _30() {
    ...
    if (!(loop7 = loop7.step()).done) {
      ...
      return M.yldStar(M.yldStar(a), _31, _65);
    } else {
      fc7 = _33, fe7 = _44;
  ...
  function _35() {
    ...
    if (!(loop8 = loop8.step()).done) {
      ...
      return M.yldStar(M.yldStar(a), _36, _66);
    } else {
      fc8 = _38, fe8 = _44;
  ...
  function _39() {
    ...
    if (!(loop9 = loop9.step()).done) {
      ...
      return M.yldStar(M.yldStar(a), _40, _67);
    } else {
      fc9 = _42, fe9 = _44;
  ...
  function _58(a) {
    _fc = _47, _fe = _44, _err = a;
    return M.jump(void 0, _6);
  }

  function _59(a) {
    fc1 = _48, fe1 = _44, err1 = a;
    return M.jump(void 0, _9);
  }

  function _60(a) {
    fc2 = _49, fe2 = _44, err2 = a;
    return M.jump(void 0, _12);
  }

  function _61(a) {
    fc3 = _50, fe3 = _44, err3 = a;
    return M.jump(void 0, _15);
  }

  function _62(a) {
    fc4 = _51, fe4 = _44, err4 = a;
    return M.jump(void 0, _19);
  }

  function _63(a) {
    fc5 = _52, fe5 = _44, err5 = a;
    return M.jump(void 0, _23);
  }

  function _64(a) {
    fc6 = _53, fe6 = _44, err6 = a;
    return M.jump(void 0, _27);
  }

  function _65(a) {
    fc7 = _54, fe7 = _44, err7 = a;
    return M.jump(void 0, _32);
  }

  function _66(a) {
    fc8 = _55, fe8 = _44, err8 = a;
    return M.jump(void 0, _37);
  }

  function _67(a) {
    fc9 = _56, fe9 = _44, err9 = a;
    return M.jump(void 0, _41);
  }
}