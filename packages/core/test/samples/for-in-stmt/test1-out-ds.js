...
var $M = require("@effectful/debugger"),
  ...
  $m$8 = $M.fun("m$8", "h", null, $m$0, [], 0, 4, "49:0-67:1", 0, function ($, $l, $p) {
    for (;;) switch ($.state = $.goto) {
      case 0:
        $.goto = 1;
        $brk();
