var $M = require("@effectful/debugger"),
  ...
  for (;;) switch ($.state = $.goto) {
    ...
    $m$1 = $M.fun("m$1", "d", null, $m$0, ["i"], 1, 8, "4:0-13:1", 2, function ($, $l, $p) {
  var $1;
  ...
  switch ($.state) {
    ...
    $m$2 = $M.fun("m$2", "a4", null, $m$0, [], 0, 11, "15:0-28:1", 2, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
  ...
  switch ($.state) {
    ...
    $m$3 = $M.fun("m$3", "a5", null, $m$0, [], 0, 4, "30:0-32:1", 2, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
