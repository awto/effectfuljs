...
function c1() {
  var a = function _a() {
    ...
    a._b = function _b() {
      var b = M.generator();
      b._c1 = a._c1;
      return b.scope(b_1, b_2);
    };

    a._c1 = c1;
    return a.scope(a_11, a_21);
  },
      c1 = {};
...
function switches() {
  ...
  return switches.scope(switches_1, switches_39);
}
...
function a5_2(a5) {
  if (!(a5._loop = a5._loop.step()).done) {
    ...
    return a5.jump(void 0, a5_3, a5_5);
  }
}
...
function _a2_2(a2) {
  if (!(a2._loop = a2._loop.step()).done) {
    ...
    return a2.jump(void 0, _a2_3, a2_6);
  }
}
...
function _a3_2(a3) {
  if (!(a3._loop = a3._loop.step()).done) {
    ...
    return a3.jump(void 0, _a3_3, a3_5);
  }
}
...
function a7_1_6(a7_1, a) {
  if (a) {
    ...
    return a7_1.yldStar(a, a7_1_7, a7_1_11);
  }
}
...
function a7_2_6(a7_2, a) {
  if (a) {
    ...
    return a7_2.yldStar(a, a7_2_7, a7_2_12);
  }
}
...
function a7_6_2(a7_6, a) {
  ...
  if (a) {
    ...
    b = 1;
    return a7_6.yldStar(b, a7_6_5, a7_6_7);
  }
}
...
function a_12(a) {
  a._ = a._c2._i;
  return a.yld(`a:${a._c2._i}`, a_22, _a_3);
}
...
function inner_3(inner) {
  if (!(inner._loop = inner._loop.step()).done) {
    ...
    return inner.jump(void 0, inner_6, inner_8);
  }
}
...
function forOf_2(forOf) {
  if (!(forOf._loop = forOf._loop.step()).done) {
    ...
    return forOf.jump(void 0, forOf_3, forOf_5);
  }
}
...
function loopCapt2_2(loopCapt2) {
  ...
  if (loopCapt2._i < 3) {
    ...
    return loopCapt2.yldStar(a, loopCapt2_3, loopCapt2_5);
  } else {
...
function loopCapt3_2(loopCapt3) {
  ...
  if (loopCapt3._i < 3) {
    ...
    return loopCapt3.yldStar(a, loopCapt3_3, loopCapt3_4);
  } else {
...
function forOfCapt2_2(forOfCapt2) {
  ...
  if (!(forOfCapt2._loop = forOfCapt2._loop.step()).done) {
    ...
    return forOfCapt2.jump(void 0, forOfCapt2_3, forOfCapt2_5);
  }
}
...
function f_211(ctx) {
  ...
  if (!(ctx._loop = ctx._loop.step()).done) {
    ...
    return ctx.jump(void 0, f_311, f_53);
  }
}
...
function forOfCapt4_2(forOfCapt4) {
  ...
  if (!(forOfCapt4._loop = forOfCapt4._loop.step()).done) {
    ...
    return forOfCapt4.jump(void 0, forOfCapt4_3, forOfCapt4_5);
  }
}
...
function forOfCapt5_2(forOfCapt5) {
  ...
  if (!(forOfCapt5._loop = forOfCapt5._loop.step()).done) {
    ...
    return forOfCapt5.jump(void 0, forOfCapt5_3, forOfCapt5_5);
  }
}
...
function f_214(ctx) {
  ctx._loop = ctx.iterator(b);
  return ctx.jump(void 0, f_314, f_8);
}
...
function f_314(ctx) {
  ...
  if (!(ctx._loop = ctx._loop.step()).done) {
    ...
    return ctx.yldStar(a, f_314, f_8);
  } else {
    ctx._fc = f_54, ctx._fe = _f_6;
    return ctx.jump(void 0, f_45, _f_6);
  }
}
...
function forOfCapt6_2(forOfCapt6) {
  ...
  if (!(forOfCapt6._loop = forOfCapt6._loop.step()).done) {
    ...
    return forOfCapt6.jump(void 0, forOfCapt6_3, forOfCapt6_5);
  }
}
...
function switches_1(switches) {
  if (a) {
    return switches.yld(1, switches_2, switches_39);
  } else {
    return switches.jump(void 0, switches_2, switches_39);
  }
}
...
function switches_2(switches) {
  switch (a) {
    case 1:
      return switches.yld(2, switches_3, switches_39);
    ...
    default:
      return switches.jump(void 0, switches_4, switches_39);
  }
}

function switches_3(switches) {
  return switches.yld(3, switches_4, switches_39);
}
...
function switches_4(switches) {
  ...
  switches._i1 = 0;
  return switches.jump(void 0, switches_5, switches_39);
}
...
function switches_5(switches) {
  switch (switches._i1) {
    ...
    default:
      return switches.yld(`f2-${switches._i1}`, switches_6, switches_39);
  }
}
...
function switches_7(switches) {
  if (!(switches._loop = switches._loop.step()).done) {
    ...
    return switches.jump(void 0, switches_9, switches_39);
  }
}
  ...
  if (!(switches._loop1 = switches._loop1.step()).done) {
    ...
    switch (switches._i4) {
      case 3:
        ...
        return switches.jump(void 0, switches_12, switches_39);
  ...
  if (!(switches._loop2 = switches._loop2.step()).done) {
    ...
    switch (switches._i5) {
      case 3:
        ...
        return switches.jump(void 0, switches_15, switches_39);
...
function switches_17(switches) {
  if (!(switches._loop3 = switches._loop3.step()).done) {
    ...
    return switches.jump(void 0, switches_19, switches_39);
  }
}
...
function switches_21(switches) {
  if (!(switches._loop4 = switches._loop4.step()).done) {
    ...
    return switches.jump(void 0, switches_23, switches_39);
  }
}
...
function switches_25(switches) {
  if (!(switches._loop5 = switches._loop5.step()).done) {
    ...
    return switches.jump(void 0, switches_28, switches_39);
  }
}
...
function switches_30(switches) {
  if (!(switches._loop6 = switches._loop6.step()).done) {
    ...
    return switches.jump(void 0, switches_37, switches_39);
  }
}
