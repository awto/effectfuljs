...
$M.fun("m$1", "_inheritsLoose", "m$0", ["subClass", "superClass"], 0, function () {
  for (;;) {
    switch ($.state = $.goto) {
      ...
      case 1:
        $.goto = 2;
        $p = $M.mcall("create", Object, $.$.$1.prototype);
        continue;
      ...
      case 3:
        $M.set($.$.$0.prototype, "constructor", $.$.$0);
        $.goto = 4;
        $M.brk(2);
        continue;
...
$M.fun("m$7", null, "m$2", ["_A"], 0, function () {
  for (;;) {
    switch ($.state = $.goto) {
      ...
      case 4:
        $M.set($.$.$2, "method", $c.method($));
        $.goto = 5;
        $M.brk(17);
        continue;

      case 5:
        $M.set($.$.$1, "smethod", $c.smethod($));
        $.goto = 6;
        $M.brk(19);
        continue;
...
$M.fun("m$9", "method", "m$7", [], 9, function () {
  for (;;) {
    switch ($.state = $.goto) {
      ...
      case 1:
        $.goto = 2;
        $p = $M.mcall("call", $.$$.$.$0.prototype.method, $.self);
        continue;
