...
function d(i) {
  ...
  function _1(d, b, i) {
    ...
    j = 0;
    a = i++;
    return M.yldStar(M.yld(a), _2, _7, i, j);
  }

  function _2(d, a, i, j) {
    var b;
    b = j++;
    return M.yldStar(M.yld((a, b)), _3, _7, i, j);
  }

  function _3(d, i, j) {
    return M.yldStar(M.yldStar(some(i += 2, j) + j), _4, _7, i);
  }

  function _4(d, a, i) {
    return M.yldStar(M.yld(a), _5, _7, i);
  }
...
function a4() {
  ...
  function _9(a4, a) {
    var b;
    b = a3();
    return M.yldStar(M.yldStar(b), _10, _12, a);
  }
  ...
  function _15(a4, a) {
    return M.jump(void 0, _6, _12, _13, _12, a);
  }
}
