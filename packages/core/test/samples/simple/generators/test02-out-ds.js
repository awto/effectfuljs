var $M = require("@effectful/debugger"),
  ...
  for (;;) switch ($.state = $.goto) {
    ...
    $m$5 = $M.fun("m$5", "a", null, $m$4, ["a8"], 0, 9, "20:2-37:3", 2, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $lset($l, 5, $m$7($));
      $lset($l, 6, $m$8($));
  ...
  for (;;) switch ($.state = $.goto) {
    ...
    $m$14 = $M.fun("m$14", "b", null, $m$0, [], 0, 19, "61:0-66:1", 2, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
