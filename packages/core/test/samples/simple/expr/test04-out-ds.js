var $M = require("@effectful/debugger"),
  ...
  for (;;) switch ($.state = $.goto) {
    ...
    $m$1 = $M.fun("m$1", "e", null, $m$0, [], 0, 2, "1:0-3:1", 0, function e($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk("2:2-2:31");
...
}, null, null, 1, [[4, "2:2-2:31", $s$2], [2, "2:14-2:20", $s$2], [2, "2:23-2:29", $s$2], [2, "2:2-2:30", $s$2], [16, "3:1-3:1", $s$2], [16, "3:1-3:1", $s$2]]);
