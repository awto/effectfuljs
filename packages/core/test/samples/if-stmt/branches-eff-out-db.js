var $M = require("@effectful/debugger"),
  ...
  f: [6, "33:9-33:10"]
    ...
    $s$6 = [{}, $s$1, 1],
    $s$7 = [{}, $s$1, 1],
    $m$0 = $M.fun("m$0", "file.js", null, null, [], 0, 7, "1:0-37:0", 160, function file_js($, $l, $p) {
  ...
  for (;;) switch ($.state = $.goto) {
    ...
    $m$3 = $M.fun("m$3", "c", null, $m$0, [], 0, 1, "12:0-17:1", 128, function c($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      if (true) {
        $.goto = 1;
    ...
    $m$4 = $M.fun("m$4", "d", null, $m$0, [], 0, 1, "19:0-25:1", 128, function d($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      ($x.call = eff)("a");
    ...
    $m$5 = $M.fun("m$5", "e", null, $m$0, [], 0, 1, "27:0-31:1", 128, function e($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $p = ($x.call = eff)(1);
    ...
    $m$6 = $M.fun("m$6", "f", null, $m$0, [], 0, 1, "33:0-36:1", 128, function f($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $p = ($x.call = eff)(1);
