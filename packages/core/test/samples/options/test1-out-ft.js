...
function b_1(b) {
  return M.chain(eff(1), b_2, b_8);
}

function b_2(b) {
  return M.chain(eff(2), b_3, b_8);
}

function b_3(b) {
  return M.chain(eff(3), b_4, b_8);
}

function b_4(b) {
  return M.chain(eff(4), b_5, b_8);
}

function b_5(b) {
  return M.chain(eff(5), b_6, b_8);
}

function b_6(b) {
  return M.chain(eff(6), b_7, b_8);
}
...
function c_5(c) {
  return M.chain(eff(5), c_6, c_8);
}

function c_6(c) {
  return M.chain(eff(6), c_7, c_8);
}
