var $M = require("@effectful/debugger"),
  ...
  a: [1, "3:12-3:13"]
    ...
    $s$3 = [{}, $s$1, 1],
    $m$0 = $M.fun("m$0", "file.js", null, null, [], 0, 3, "1:0-10:0", 160, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    ...
    $m$1 = $M.fun("m$1", "a1", null, $m$0, ["a"], 0, 2, "3:0-5:1", 136, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.self.a = $l[1];
      $.goto = 2;
    ...
    $m$2 = $M.fun("m$2", "b", null, $m$0, [], 0, 1, "7:0-9:1", 128, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 2;
      ($x.call = $l[0][1])();
