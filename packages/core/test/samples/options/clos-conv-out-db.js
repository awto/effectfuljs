...
var $M = require("@effectful/debugger"),
  ...
  $s$5 = [{}, $s$4, 2],
  $m$0 = $M.fun("m$0", "file.js", null, null, [], 0, 4, "1:0-23:0", 160, function ($, $l, $p) {
  ...
  $m$1 = $M.fun("m$1", "yh", null, $m$0, ["a"], 0, 3, "3:0-9:1", 128, function ($, $l, $p) {
    for (;;) switch ($.state = $.goto) {
      case 0:
        $l[2] = $l[0][1] = $l[0][1] + $l[1];
        $.goto = 1;
  ...
  $m$2 = $M.fun("m$2", "eh", null, $m$1, [], 0, 1, "6:9-8:3", 128, function ($, $l, $p) {
    for (;;) switch ($.state = $.goto) {
      case 0:
        $.goto = 2;
  ...
  $m$3 = $M.fun("m$3", "yh2", null, $m$0, ["a"], 0, 3, "16:0-22:1", 128, function ($, $l, $p) {
    for (;;) switch ($.state = $.goto) {
      case 0:
        $l[2] = $l[0][1] = $l[0][1] + $l[1];
        $.goto = 1;
  ...
  $m$4 = $M.fun("m$4", "eh", null, $m$3, [], 0, 1, "19:9-21:3", 128, function ($, $l, $p) {
    for (;;) switch ($.state = $.goto) {
      case 0:
        $.goto = 2;
        ($x.call = eff)($l[0][0][1] = $l[0][0][1] + $l[0][2]);
