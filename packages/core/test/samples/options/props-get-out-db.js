var $M = require("@effectful/debugger"),
  ...
  v: [3, "12:10-12:11"]
    ...
    $m$0 = $M.fun("m$0", "file.js", null, null, [], 0, 2, "1:0-24:0", 160, function file_js($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    ...
    $m$1 = $M.fun("m$1", "tuza", null, $m$0, [], 0, 3, "1:0-23:1", 128, function tuza($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $l[2] = $m$2($);
      $l[1] = 1;
    ...
    $m$2 = $M.fun("m$2", "tuzb", null, $m$1, [], 3, 6, "4:2-22:3", 128, function tuzb($, $l, $p) {
  var $3, $2, $1;
