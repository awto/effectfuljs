var $M = require("@effectful/debugger"),
  ...
  deferred: [3, "28:8-28:16"]
    ...
    $s$8 = [{}, $s$7, 3],
    $m$0 = $M.fun("m$0", "file.js", null, null, [], 0, 3, "1:0-35:0", 160, function ($, $l, $p) {
  ...
  for (;;) switch ($.state = $.goto) {
    ...
    $m$3 = $M.fun("m$3", "b", null, $m$0, [], 0, 2, "16:0-34:1", 128, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $l[1] = $m$5($);
      $.goto = 1;
  ...
  switch ($.state) {
    ...
    $m$5 = $M.fun("m$5", "addLater", null, $m$3, ["a", "b"], 0, 4, "27:2-33:3", 128, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $p = $mcall("defer", Q);
