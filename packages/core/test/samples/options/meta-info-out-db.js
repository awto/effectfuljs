var $M = require("@effectful/debugger"),
  ...
  $m$1 = $M.fun("m$1", "a2", null, $m$0, [], 0, 3, "1:0-13:1", 128, function ($, $l, $p) {
    for (;;) switch ($.state = $.goto) {
      case 0:
        $l[2] = $m$2($);
        $l[1] = 0;
  ...
  $m$2 = $M.fun("m$2", "c", null, $m$1, [], 0, 3, "3:2-11:3", 128, function ($, $l, $p) {
    for (;;) switch ($.state = $.goto) {
      case 0:
        $l[2] = $m$3($);
        $l[1] = 0;
  ...
  $m$3 = $M.fun("m$3", "b", null, $m$2, ["j"], 0, 3, "5:4-9:5", 128, function ($, $l, $p) {
    for (;;) switch ($.state = $.goto) {
      case 0:
        $l[2] = $l[1] + $l[0][0][1];
