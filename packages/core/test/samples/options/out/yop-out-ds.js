...
var $0M = require("@effectful/debugger"),
  ...
  $0m$10 = $0M.fun("m$10", null, null, $0m$9, ["err"], 0, 3, "34:19-42:11", 0, function ($0, $0l, $0p) {
    for (;;) switch ($0.state = $0.goto) {
      ...
      case 2:
        $0.goto = 3;
        $0p = ($0x.call = $0get, $0l[1].message);
        $0.state = 3;
      case 3:
        $0.goto = 4;
        $0p = ($0x.call = expect)($0p);
        $0.state = 4;
      case 4:
        $0.goto = 5;
        $0p = ($0x.call = $0get, $0p.to);
