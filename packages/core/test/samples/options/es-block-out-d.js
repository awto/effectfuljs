  ...
  for (;;) {
    switch ($.state = $.goto) {
      ...
      case 4:
        $0 = $.$.$0.default;
        $.goto = 5;
        ($M.context.call = $0.option).dbg$call($0, {
          combineOps: true,
          scopeContext: true,
          scopePrefix: true,
          contextState: false,
...
}, null, null, [["1:0-1:32", "s", $s$1], [null, "e", $s$1], [null, "e", $s$1], ["4:0-19:3", "s", $s$1], ["4:0-19:2", "e", $s$1], [], [], []]);
  ...
  for (;;) {
    switch ($.state = $.goto) {
      ...
      case 3:
        $0 = $.$$.$.$0.default;
        $.goto = 4;
        ($M.context.call = $0.block).dbg$call($0, "par");
        continue;
...
}, null, null, [["22:2-22:12", "s", $s$1], [null, null, null], ["24:4-24:19", "s", $s$1], ["24:4-24:18", "e", $s$1], ["25:4-25:14", "s", $s$1], [null, null, null], ["26:4-26:14", "s", $s$1], [null, null, null], [], [], []]);
$M.fun("m$5", "b", "m$0", [], 1, function () {
  for (;;) {
    switch ($.state = $.goto) {
      case 0:
        $.goto = 1;
...
}, null, null, [["31:2-31:12", "s", $s$1], [null, null, null], ["33:4-33:16", "s", $s$1], ["33:4-33:15", "e", $s$1], ["34:4-34:14", "s", $s$1], [null, null, null], ["35:4-35:14", "s", $s$1], [null, null, null], [], [], []]);
$M.fun("m$6", "c", "m$0", [], 1, function () {
  for (;;) {
    switch ($.state = $.goto) {
      case 0:
        $.goto = 1;
...
}, null, null, [["40:2-40:12", "s", $s$1], [null, null, null], ["42:4-42:17", "s", $s$1], ["42:4-42:16", "e", $s$1], ["43:4-43:14", "s", $s$1], [null, null, null], ["44:4-44:14", "s", $s$1], [null, null, null], [], [], []]);
$M.fun("m$7", "d", "m$0", [], 1, function () {
  for (;;) {
    switch ($.state = $.goto) {
      case 0:
        $.goto = 1;
...
}, null, null, [["49:2-49:12", "s", $s$1], [null, null, null], ["51:4-51:12", "s", $s$1], ["52:4-52:14", "s", $s$1], [null, null, null], ["53:4-53:14", "s", $s$1], [null, null, null], [], [], []]);
