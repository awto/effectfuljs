var $M = require("@effectful/debugger/api"),
  ...
  b: [2, "26:15-26:16"]
    ...
    $s$6 = [{}, $s$1, 1],
    $s$7 = [{}, $s$1, 1],
    $m$0 = $M.fun("m$0", "file.js", null, null, [], 0, 7, "1:0-61:0", 160, function file_js($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    ...
    $m$1 = $M.fun("m$1", "a1", null, $m$0, ["a", "b"], 0, 3, "3:0-10:1", 128, function a1($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
    ...
    $m$2 = $M.fun("m$2", "a2", null, $m$0, ["a", "b"], 0, 3, "14:0-22:1", 128, function a2($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
    ...
    $m$3 = $M.fun("m$3", "a3", null, $m$0, ["a", "b"], 0, 3, "26:0-33:1", 128, function a3($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      ($context.call = eff)($l[1]);
    ...
    $m$4 = $M.fun("m$4", "a4", null, $m$0, [], 0, 2, "37:0-42:1", 128, function a4($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $l[1] = B.B;
      $.goto = 1;
    ...
    $m$5 = $M.fun("m$5", "a5", null, $m$0, [], 0, 2, "46:0-51:1", 128, function a5($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $l[1] = B.B;
      $.goto = 1;
    ...
    $m$6 = $M.fun("m$6", "a6", null, $m$0, [], 0, 2, "55:0-60:1", 128, function a6($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $l[1] = B.B;
      $.goto = 1;
