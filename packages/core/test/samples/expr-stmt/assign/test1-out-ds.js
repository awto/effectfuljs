...
$M.fun("m$3", "_objectWithoutProperties", "m$0", ["source", "excluded"], 0, function () {
  for (;;) {
    switch ($.state = $.goto) {
      ...
      case 9:
        $.goto = 10;
        $p = $M.mcall("getOwnPropertySymbols", Object, $.$.$0);
        continue;
      ...
      case 17:
        $.goto = 18;
        $p = $M.mcall("call", Object.prototype.propertyIsEnumerable, $.$.$0, $.$.$3);
        continue;
...
$M.fun("m$15", "c", "m$0", [], 0, function () {
  for (;;) {
    switch ($.state = $.goto) {
      ...
      case 17:
        $M.lset($.$, "a", $M.lset($.$, "b", $M.lset($.$, "c", $M.lset($.$, "d", $M.lset($.$, "e", $M.lset($.$, "f", $M.lset($.$, "g", $M.lset($.$, "j", $M.lset($.$, "x", $M.lset($.$, "y", $M.lset($.$, "z", 1000)))))))))));
        $.goto = 18;
        $M.brk(81);
        continue;
...
$M.fun("m$16", "d", "m$0", [], 0, function () {
  for (;;) {
    switch ($.state = $.goto) {
      ...
      case 8:
        $M.set($p, "some", $p.some + 1);
        $.goto = 9;
        $M.brk(85);
        continue;

      case 9:
        $M.set(some, "d", some["d"] - 1);
        return $M.ret();
