...
(function () {
  ...
  ref = [1, 2, 3];
  i = 0;
  return M.jump(void 0, _1, _7, i, ref);
  ...
  function _2(i, ref) {
    var j, len;
    j = 0, len = ref.length;
    return M.jump(void 0, _3, _7, i, j, len, ref);
  }
  ...
  function _3(i, j, len, ref) {
    if (j < len) {
      ...
      return M.jump(void 0, _6, _7, i, ref);
    }
  }

  function _4(a, i, j, len, ref) {
    if (a) {
      return M.jump(void 0, _5, _7, i, j, len, ref);
    } else {
      if (t1) {
        return M.jump(void 0, _6, _7, i, ref);
      } else {
...
(function () {
  ...
  ref = [1, 2, 3];
  i = 0;
  return M.jump(void 0, _1, _8, i, ref);
  ...
  function _2(i, ref) {
    var j, len;
    j = 0, len = ref.length;
    return M.jump(void 0, _3, _8, i, j, len, ref);
  }
  ...
  function _3(i, j, len, ref) {
    if (j < len) {
      ...
      return M.jump(void 0, _7, _8, i, ref);
    }
  }

  function _4(a, i, j, len, ref) {
    if (a) {
      return M.jump(void 0, _6, _8, i, j, len, ref);
    } else {
...
(function () {
  ...
  ref = [1, 2, 3];
  i = 0;
  return M.jump(void 0, _1, _7, i, void 0, ref);
  ...
  function _3(i, j, len, ref) {
    if (j < len) {
      ...
      return M.jump(void 0, _5, _7, i, j, ref);
    }
  }
  ...
  function _5(i, j, ref) {
    i++;
    return M.jump(void 0, _1, _7, i, j, ref);
  }
...
(function () {
  ...
  function _1(j, len, ref) {
    if (j < len) {
      d = ref[j];
      return M.chain(eff(d), _2, _4, j, len, ref);
    } else {
      return M.pure();
    }
  }
...
(function () {
  var j, len;
  j = 0;
  return M.jump(void 0, _1, _5, j);

  function _1(j) {
    if (true) {
      return M.chain(eff(j), _2, _5, j);
    } else {
      return M.jump(void 0, _3, _5, j);
    }
  }
