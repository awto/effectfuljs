var $M = require("@effectful/debugger"),
  ...
  for (;;) switch ($.state = $.goto) {
    ...
    $m$1 = $M.fun("m$1", "f1", null, $m$0, [], 0, 5, "1:0-12:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
    ...
    $m$2 = $M.fun("m$2", "f2", null, $m$0, [], 0, 5, "14:0-25:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
    ...
    $m$3 = $M.fun("m$3", "f3", null, $m$0, [], 0, 5, "26:0-39:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
    ...
    $m$4 = $M.fun("m$4", "f4", null, $m$0, [], 0, 5, "40:0-49:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
    ...
    $m$5 = $M.fun("m$5", "f5", null, $m$0, [], 0, 3, "51:0-59:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
