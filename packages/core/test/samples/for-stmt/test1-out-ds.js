var $M = require("@effectful/debugger"),
  ...
  switch ($.state) {
    ...
    $m$5 = $M.fun("m$5", "a", null, $m$0, [], 0, 3, "37:0-44:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
  ...
  switch ($.state) {
    ...
    $m$6 = $M.fun("m$6", "a1", null, $m$0, [], 0, 4, "46:0-53:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
  ...
  switch ($.state) {
    ...
    $m$7 = $M.fun("m$7", "b", null, $m$0, [], 0, 2, "54:0-61:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
  ...
  switch ($.state) {
    ...
    $m$8 = $M.fun("m$8", "c", null, $m$0, [], 0, 2, "62:0-70:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
  ...
  switch ($.state) {
    ...
    $m$9 = $M.fun("m$9", "d", null, $m$0, [], 0, 4, "71:0-78:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
  ...
  switch ($.state) {
    ...
    $m$10 = $M.fun("m$10", "e", null, $m$0, [], 0, 4, "79:0-86:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
  ...
  switch ($.state) {
    ...
    $m$11 = $M.fun("m$11", "f", null, $m$0, [], 0, 4, "87:0-94:1", 0, function ($, $l, $p) {
  for (;;) switch ($.state = $.goto) {
    case 0:
      $.goto = 1;
      $brk();
  ...
  for (;;) switch ($.state = $.goto) {
    ...
    case 1:
      $.goto = 2;
      ($x.call = eff)($lset($l[0][0], 1, $l[0][0][1] + $lset($l[0], 1, $l[0][1] + $l[1])));
      $.state = 2;
