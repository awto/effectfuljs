...
describe("`usePromise`", function() {
  test("simple", async function() {
    ...
    while(mockCont.mock.calls.length === 0)
      await null
    expect(mockCont).toBeCalledTimes(1)
...
describe("<Suspense/>", function() {
  ...
  test("with pure child", function() {
    function Component1() {
      "component"
      return <h1><M.Suspense><i>hi</i></M.Suspense></h1>
    }
      ...
      function Component6() {
        ...
        return (<h1>
                  <M.Suspense maxDuration={1500} fallback={<div>Loading...</div>}>
                    ...
                    <p>
                      {M.usePromise(delay(<i>there</i>,2000))}
                    </p>
                  </M.Suspense>
                </h1>)
      }
...
test("errors handling", async function() {
  ...
  function TestComponent() {
    ...
    return (
        ...
        <h1>May Throw</h1>
        <ErrorBoundary>
          <p>P1: <ThrowsSometimes interval={200}
                   error="Error1" normal={<b>Normal1</b>}/>
          </p>
          <p>P2: <ThrowsSometimes interval={100}
                   error="Error2" normal={<i>Normal2</i>} iterations={8}/>
          </p>
        </ErrorBoundary>
      </div>)
  }
